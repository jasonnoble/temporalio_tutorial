 ...
 */
export declare type Handler<Ret, Args extends any[], T extends SignalDefinition<Args> | QueryDefinition<Ret, Args>> = T extends SignalDefinition<infer A> ? (...args: A) => void | Promise<void> : T extends QueryDefinition<infer R, infer A> ? (...args: A) => R : never;
/**
 * A handler function accepting signals calls for non-registered signal names.
 */
export declare type DefaultSignalHandler = (signalName: string, ...args: unknown[]) => void | Promise<void>;
