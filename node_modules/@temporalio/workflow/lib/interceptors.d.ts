 ...
 */
export declare type ContinueAsNewInputOptions = ContinueAsNewOptions & Required<Pick<ContinueAsNewOptions, 'workflowType'>>;
 ...
 * ```
 */
export declare type WorkflowInterceptorsFactory = () => WorkflowInterceptors;
