...
export declare type ActivationHandlerFunction<K extends keyof coresdk.workflow_activation.IWorkflowActivationJob> = (activation: NonNullable<coresdk.workflow_activation.IWorkflowActivationJob[K]>) => void;
/**
 ...
 */
export declare const LATEST_INTERNAL_PATCH_NUMBER = 1;
/**
...
export declare class Activator implements ActivationHandler {
    ...
    checkInternalPatchAtLeast(minimumPatchNumber: number): boolean;
