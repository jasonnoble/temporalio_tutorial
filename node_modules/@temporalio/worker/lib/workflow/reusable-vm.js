...
class ReusableVMWorkflowCreator {
    constructor(script, workflowBundle, isolateExecutionTimeoutMs) {
        ...
        const globals = { AsyncLocalStorage: node_async_hooks_1.AsyncLocalStorage, assert: node_assert_1.default, __webpack_module_cache__ };
     ...
     */
    static async create(workflowBundle, isolateExecutionTimeoutMs) {
        ...
        return new this(script, workflowBundle, isolateExecutionTimeoutMs);
    }
    /**
