...
class ThreadedVMWorkflowCreator {
     ...
     */
    static async create({ threadPoolSize, workflowBundle, isolateExecutionTimeoutMs, reuseV8Context, }) {
        ...
        await Promise.all(workerThreadClients.map((client) => client.send({ type: 'init', workflowBundle, isolateExecutionTimeoutMs, reuseV8Context })));
