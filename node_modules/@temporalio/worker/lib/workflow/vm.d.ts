...
export declare class VMWorkflowCreator implements WorkflowCreator {
     ...
     */
    static create<T extends typeof VMWorkflowCreator>(this: T, workflowBundle: WorkflowBundleWithSourceMapAndFilename, isolateExecutionTimeoutMs: number): Promise<InstanceType<T>>;
    /**
