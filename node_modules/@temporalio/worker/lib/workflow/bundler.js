...
exports.bundleWorkflowCode = exports.WorkflowCodeBundler = exports.moduleMatches = exports.disallowedModules = exports.disallowedBuiltinModules = exports.allowedBuiltinModules = exports.defaultWorflowInterceptorModules = void 0;
...
exports.defaultWorflowInterceptorModules = [require.resolve('../workflow-log-interceptor')];
exports.allowedBuiltinModules = ['assert'];
...
class WorkflowCodeBundler {
    constructor({ logger, workflowsPath, payloadConverterPath, failureConverterPath, workflowInterceptorModules, ignoreModules, webpackConfigHook, }) {
        ...
        this.workflowInterceptorModules = workflowInterceptorModules ?? exports.defaultWorflowInterceptorModules;
