...
export declare class CoreLogger extends DefaultLogger {
...
declare type TrackedNativeObject = native.Client | native.Worker | native.EphemeralServer;
/**
...
export declare class Runtime {
    ...
    protected readonly shouldPollForLogs: BehaviorSubject<boolean>;
    ...
    protected initLogPolling(logger: CoreLogger): Promise<void>;
