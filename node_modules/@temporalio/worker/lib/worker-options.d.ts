...
export declare type WorkflowBundleOption = WorkflowBundle | WorkflowBundleWithSourceMap | WorkflowBundlePath | WorkflowBundlePathWithSourceMap;
 ...
 */
export declare type WorkerOptionsWithDefaults = WorkerOptions & Required<Pick<WorkerOptions, 'namespace' | 'identity' | 'shutdownGraceTime' | 'maxConcurrentActivityTaskExecutions' | 'maxConcurrentLocalActivityExecutions' | 'maxConcurrentWorkflowTaskExecutions' | 'enableNonLocalActivities' | 'stickyQueueScheduleToStartTimeout' | 'maxCachedWorkflows' | 'maxHeartbeatThrottleInterval' | 'defaultHeartbeatThrottleInterval' | 'enableSDKTracing' | 'showStackTraceSources' | 'debugMode' | 'reuseV8Context'>> & {
    /**
 ...
 */
export interface ReplayWorkerOptions extends Omit<WorkerOptions, 'connection' | 'namespace' | 'taskQueue' | 'activities' | 'maxConcurrentActivityTaskExecutions' | 'maxConcurrentLocalActivityExecutions' | 'maxConcurrentWorkflowTaskExecutions' | 'maxHeartbeatThrottleInterval' | 'defaultHeartbeatThrottleInterval' | 'debugMode' | 'enableNonLocalActivities' | 'maxActivitiesPerSecond' | 'maxTaskQueueActivitiesPerSecond' | 'stickyQueueScheduleToStartTimeout' | 'maxCachedWorkflows'> {
    /**
 ...
 */
export declare function defaultSinks(logger?: import("./logger").Logger): InjectedSinks<LoggerSinks>;
/**
 * Appends the default Worker logging interceptors to given interceptor arrays.
 *
 * @param logger a {@link Logger} - defaults to the {@link Runtime} singleton logger.
 */
export declare function appendDefaultInterceptors(interceptors: WorkerInterceptors, logger?: import("./logger").Logger): WorkerInterceptors;
export declare function addDefaultWorkerOptions(options: WorkerOptions): WorkerOptionsWithDefaults;
export declare function compileWorkerOptions(opts: WorkerOptionsWithDefaults): CompiledWorkerOptions;
