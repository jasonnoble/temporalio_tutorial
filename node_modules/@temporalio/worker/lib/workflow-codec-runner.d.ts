...
declare type DecodedActivation = Decoded<coresdk.workflow_activation.IWorkflowActivation>;
/**
...
export declare class WorkflowCodecRunner {
     ...
     */
    decodeActivation(activation: coresdk.workflow_activation.IWorkflowActivation): Promise<DecodedActivation>;
    /**
