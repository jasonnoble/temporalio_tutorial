...
declare type TLSConfig = native.TLSConfig;
export { TLSConfig };
...
export declare type RequiredNativeConnectionOptions = Omit<Required<NativeConnectionOptions>, 'tls' | 'metadata'> & {
    tls?: NativeConnectionOptions['tls'];
    metadata?: NativeConnectionOptions['metadata'];
    sdkVersion: string;
};
export declare function getDefaultConnectionOptions(): RequiredNativeConnectionOptions;
export declare function compileConnectionOptions(options: RequiredNativeConnectionOptions): RequiredNativeConnectionOptions;
